...
// функция которая добовляет area и метод в объект каким по пало и это очень не безопасно
// Mixin as a function
...
// Mixin to single object  единичное применения
mixinCalculateCost(g1);

// Mixin to array of objects для все приминение
